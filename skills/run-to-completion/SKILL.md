...
1. **Ask blocking questions up front.** Before starting, surface any genuinely blocking, matter-of-taste question you can already foresee (naming, structural choices, scope boundaries) — get those resolved once, before execution begins.
